...
const suggestions = [
  "Write landing page copy for a virtual assistant platform",
  "Generate a landing page for an AI SaaS product",
  "Copy for a landing page promoting a free eBook",
  "Sales page for a personal fitness app",
  "Landing page for an online clothing store"
];
...
export default function ToolLandingPage() {
  ...
  const [messages, setMessages] = useState([
    {
      sender: "ai",
      text: "Hi! Describe your product or offer and I’ll generate your landing page copy."
    }
  ]);
    ...
    <div className="flex h-screen bg-black text-white">
      ...
      <main className="flex-1 p-6 flex flex-col items-center overflow-hidden">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-1">🌐 Landing Page Writer</h1>
          <p className="text-gray-400 text-sm">
            Tell me about your product or service and I’ll craft high-converting landing page content.
          </p>
        </div>
          ...
          {messages.map((msg, index) => (
            <div
              ...
              className={`relative text-sm w-fit max-w-[80%] px-4 py-3 rounded-lg ${
                msg.sender === "user"
                  ? "ml-auto bg-gradient-to-r from-cyan-500 to-blue-600"
                  : "bg-gray-800"
              }`}
            >
              {msg.text}
        ...
        <div className="w-full max-w-3xl mt-6 flex gap-2">
          <input
            ...
            className="flex-grow px-4 py-3 rounded-xl bg-[#222] text-white placeholder-gray-500 border border-gray-700 focus:border-cyan-500 outline-none"
          />
          <button
            onClick={sendMessage}
            disabled={loading}
