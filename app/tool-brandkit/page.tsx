...
const suggestions = [
  "Create a brand kit for a skincare business",
  "Generate a name and slogan for a fitness brand",
  "Give me brand colors for a tech startup",
  "Create a brand voice for a fashion label",
  "Build a brand identity for a consulting agency"
];

export default function ToolBrandKit() {
  const [input, setInput] = useState("");
  const [placeholderIndex, setPlaceholderIndex] = useState(0);
  const [messages, setMessages] = useState([
    {
      sender: "ai",
      text: "Hi! What kind of brand are we building today?"
    }
  ]);
    ...
    <div className="flex h-screen bg-black text-white">
      ...
      <main className="flex-1 p-6 flex flex-col items-center overflow-hidden">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold mb-1">🎨 Brand Kit Builder</h1>
          <p className="text-gray-400 text-sm">
            Describe your brand or business and I’ll build you a kit.
          </p>
        </div>
